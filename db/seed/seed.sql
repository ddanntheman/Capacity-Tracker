...
MERGE [People] AS t
USING (VALUES
    (@alice, N'Alice Anderson', N'alice@example.com', N'Managing Director', NULL, 1),
    (@bob,   N'Bob Brown',      N'bob@example.com',   N'Senior Consultant', @alice, 1),
    (@carol, N'Carol Clarke',   N'carol@example.com', N'Consultant',        @alice, 1),
    (@dave,  N'Dave Davis',     N'dave@example.com',  N'Analyst',           @bob,   1)
